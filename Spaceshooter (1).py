...
class PlayerCannon(Actor):
    ...
    def __init__(self, x, y):
        super(PlayerCannon, self).__init__('cannon.png', x, y)
...
class Alien(Actor): 
    ...
    TYPES= {
        '1':(load_animation('alien1.png'), 40),
        '2':(load_animation('alien2.png'), 20),
        '3':(load_animation('alien3.png'), 10)
    }
...
class MysteryShip(Alien):
    ...
    def __init__(self, x, y):
        ...
        super(MysteryShip, self).__init__('alien4.png', x, y, score)
...
class AlienGroup(object):
    ...
    def update(self, elapsed):
        ...
        while self.elapsed >= self.period:
            self.elapsed -= self.period  #這一行的-怪怪的
